...
public class KpiService : IKpiService
{
        ...
        List<Denial> denials)
    {
        ...
        var dirtyClaimIds = scrubIssues
            .Where(si => string.Equals(si.Severity, "Error", StringComparison.OrdinalIgnoreCase) && si.ClaimId.HasValue)
        ...
        var totalScrubErrors = scrubIssues.Count(si =>
            string.Equals(si.Severity, "Error", StringComparison.OrdinalIgnoreCase) &&
